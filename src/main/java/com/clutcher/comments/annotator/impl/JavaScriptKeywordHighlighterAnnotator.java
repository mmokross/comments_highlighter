...
public class JavaScriptKeywordHighlighterAnnotator extends AbstractKeywordHighlighterAnnotator {

    private final Class<?> keywordTokenClazz;
    private final Class<?> methodClazz;

    public JavaScriptKeywordHighlighterAnnotator() {
        this.keywordTokenClazz = AnnotatorUtils.findClassByName("com.intellij.lang.javascript.JSElementType");
        this.methodClazz = AnnotatorUtils.findClassByName("com.intellij.lang.javascript.psi.JSFunction");
    }
